...
export function getPoColumns(t: TranslationMap): ColumnConfig[] {
  return [
    ...
    { key: 'documentDate', label: t.columns.documentDate, sortable: true, width: COLUMN_WIDTHS.documentDate, align: 'center' },
    ...
    { key: 'deliveryDate', label: t.columns.deliveryDate, sortable: true, width: COLUMN_WIDTHS.deliveryDate, align: 'center' },
